        ...
        <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className=' bg-slate-500 min-w-[50%] max-h-[50%] sm:w-[350px]  md:w-450px lg:w-[650px]'>
                    ...
                    <div className=' bg-white  min-h-[50%] flex justify-center items-center'>
                        ...
                        <button type='submit' className='mt-3 mb-6 bg-slate-400 shadow-md shadow-black w-[50%] h-8 ml-[35%]'>Login</button>
                        <p className='ml-[40%] mb-5 font-light text-sm'><a href='/signup'>Sign Up</a></p>
                        </div>
                    </div>
                </div>
            </div>
